...
4. Prefer targeted MCP tools over raw remote shell, especially for cluster-wide repo sync, repo discovery, and diagnostics.
5. Refresh or regenerate indexes after changes.
6. Report results by host.

## Tool preference

- Prefer `list_hosts`, `list_clusters`, `read_inventory`, `explain_host_role`, `explain_cluster`, `report_repo_state`, `compare_host_state`, `diagnose_host_connectivity`, `discover_host_repos`, `report_network_health`, and `generate_topology_summary` before making changes.
